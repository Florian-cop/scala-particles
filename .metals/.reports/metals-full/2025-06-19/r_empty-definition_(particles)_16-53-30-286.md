error id: file:///C:/1--Cours%20ESGI/4ESGI/Scala/particles/src/main/scala/particles/Main.scala:draw.
file:///C:/1--Cours%20ESGI/4ESGI/Scala/particles/src/main/scala/particles/Main.scala
empty definition using pc, found symbol in pc: draw.
semanticdb not found

found definition using fallback; symbol draw
offset: 2384
...
object ParticlesApp extends JFXApp3 {
  ...
  def drawParticles(particles: List[Particle]): List[Circle] = particles.map(_.dr@@aw)
